...
export default function Footer() {
  return (
    <footer className="bg-neutral-950 border-t-white pt-7 pb-1 ">
      <div className="mx-auto max-w-screen-xl container sm:px-4 md:px-4">
        <div className="flex sm:flex-col">
          <div className="flex flex-row basis-5/12 gap-6 sm:flex-col md:w-6/12">
            <a
              className="self-start focus:outline-none focus-visible:outline-primary-500"
              href="/"
            >
              <svg
                fill="none"
            ...
            <div className="flex flex-col space-y-2 w-full">
              ...
              <p className="text-[10px] text-zinc-200">
                <a
                  ...
                  className="transition-colors hover:text-primary-500 focus:outline-none focus-visible:outline-primary-500"
                  href="/P.O.BOX%20%202615%20-%20Dubai,%20United%20Arab%20Emirates"
                >
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                  className="transition-colors hover:text-primary-500 focus:outline-none focus-visible:outline-primary-500"
                  href="mailto:Info@amcolubricants.com"
                >
                  Info@amcolubricants.com
                </a>
              </p>
              <p className="text-[10px] text-gray-400">
                Copyright © AMCO Lubricants 2023. All rights reserved.
              </p>
            </div>
          </div>
          <div className="flex gap-4 flex-col basis-3/12 md:w-2/12 sm:mt-8">
            <div className="text-slate-500 text-[10px] font-bold font-campton-bold leading-[10px]">
              Main Pages
            </div>
            <a
              className="text-zinc-200 text-xs font-bold font-campton-bold leading-[14.12px]"
              href="#"
            >
              Home
            </a>
          ...
          <div className="flex gap-4 flex-col basis-4/12 md:w-4/12 sm:mt-8">
            <div className="text-slate-500 text-[10px] font-bold font-campton-bold leading-[10px]">
              Product Pages
            </div>
            <div className="flex flex-row flex-wrap sm:flex-col">
              <a
                className="text-zinc-200 text-xs font-bold font-campton-bold leading-[14.12px] w-1/2 pb-4 sm:w-full"
                href="#"
              >
                Products Home
              </a>
              ...
              <a
                className="text-zinc-200 text-xs font-bold font-campton-bold leading-[14.12px] w-1/2 pb-4"
                href="#"
              >
